...
'Checking whether the User said yes (6) or no (7) to the question about the battery 
'The result of that was stored in the var "report" in part 1
'This will generate at least 4 runtime errors if they said yes incorrectly, if they said no incorrectly it won't care
if (report = "6") then
